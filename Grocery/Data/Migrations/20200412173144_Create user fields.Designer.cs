...
namespace Grocery.Data.Migrations
{
    ...
    [Migration("20200412173144_Create user fields")]
    partial class Createuserfields
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Grocery.Models.ApplicationUser", b =>
                {
            ...
            modelBuilder.Entity("Grocery.Models.Mark", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("Grocery.Models.Product", b =>
                {
                    ...
                    b.HasOne("Grocery.Models.Mark", "Mark")
                        .WithMany("Products")
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("Grocery.Models.ApplicationUser", null)
                        .WithMany()
